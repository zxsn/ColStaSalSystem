...
/**
    * @ClassName: ManageSalaryChange
    * @Description: TODO(管理人员薪级工资套改表)
    * @author 追鑫少年
    * @date 2017年6月1日
    *
    */
@Entity
@Table(name = "manSalCha_table", schema = "employee")
public class ManageSalaryChange {
    ...
    private Integer payLevel;// 薪级
        ...
        /**
         * 创建一个新的实例 ManageSalaryChange.
         *
         */
        
    public ManageSalaryChange() {
        super();
    }
        ...
        public ManageSalaryChange(int id, Integer positionLevel, Integer lowBoundOfOfficeYear,
        ...
        @SequenceGenerator(name = "sequenceGenerator", sequenceName = "manSalCha_table_seq", initialValue = 1, allocationSize = 1)
            public int getId() {
                return id;
            }
