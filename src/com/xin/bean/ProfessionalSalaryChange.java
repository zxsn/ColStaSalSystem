    ...
    /**  
    * @Title: ProfessionalSalaryChange.java
...
/**
    * @ClassName: ProfessionalSalaryChange
    * @Description: TODO(专业技术人员薪级工资套改表)
    * @author 追鑫少年
    * @date 2017年6月1日
    *
    */
@Entity
@Table(name = "profSalCha_table", schema = "employee")
public class ProfessionalSalaryChange {
    ...
    private Integer payLevel;// 薪级
        ...
        /**
         * 创建一个新的实例 ProfessionalSalaryChange.
         *
         */
        
    public ProfessionalSalaryChange() {
        super();
    }
        ...
        public ProfessionalSalaryChange(int id, Integer positionLevel, Integer lowBoundOfOfficeYear,
                                        Integer upperBoundOfOfficeYear,
                                        Integer lowBoundOfChangeYear,
        ...
        @SequenceGenerator(name = "sequenceGenerator", sequenceName = "profSalCha_table_seq", initialValue = 1, allocationSize = 1)
            public int getId() {
                return id;
            }
